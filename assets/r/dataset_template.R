...
#
# Time-stamp: <Saturday 2024-08-03 10:38:08 +1000 Graham Williams>
#
...
# Run this after the variable `ds` (dataset) has been instantiated or
# changed.  This script will initialise the data template variables.
#
# References:
#
