# Load an Excel XLSX file into the session as `ds`.
#
...
#
# Time-stamp: <Monday 2025-03-10 05:25:16 +1100 Graham Williams>
#
...
dsname <- "<FILENAME>" %>% basename() %>% sub(".xlsx$", "", .)

assign(dsname, readxl::read_excel("<FILENAME>"))
