...
//  );
  ...
  // BUSY WAIT UNTIL COMPLETED - IS THIS THE RIGHT PLACE FOR IT?

  // WAIT HERE UNTIL WE SEE THE UNIQUE STRING FROM THIS RUN OR R.

  // Show a SnackBar when the script finishes executing. The snackbar actually
  // covers up the navigation bar and so from a interactive perspective it braws
  // the script execution to the user's attention.
  ...
  if (code.contains('Processing $script Completed')) {
    ...
    // MESSSAGE THE STATUS BAR WHEN COMPLETED INSTEAD OF SNACKBAR?
  }
}
