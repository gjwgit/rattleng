...
import 'package:rattle/features/rescale/config.dart';
import 'package:rattle/features/rescale/display.dart';

/// The SVM feature supports Svm rule analysis.

class RescalePanel extends StatelessWidget {
  const RescalePanel({super.key});
