...
//
// Time-stamp: <Friday 2024-06-14 09:58:33 +1000 Graham Williams>
//
...
import 'package:rattle/features/correlation/config.dart';
import 'package:rattle/features/correlation/display.dart';

/// The CORRELATION tab provides a data oriented view of the loaded dataset.

class CorrelationPanel extends StatelessWidget {
  const CorrelationPanel({super.key});
    ...
    return const Scaffold(
      body: Column(
        children: [
          ...
          Expanded(child: CorrelationDisplay()),
        ],
      ),
    );
  }
