...
**Text Mine:** Tap here to build the analysis of the text document(s).

''';

const randomOrderToolTip = '''

**Random Order:** Tick the checkbox to have the word cloud generated with a
...
**Stem:**. Enable this to reduces words to their base or root form.  Two
...
**Punctuation:** Extraneous data can be removed including various punctuation.

''';

const stopwordsToolTip = '''

**Stopwords:** Remove common language words. The words removed depend on the
chosen language.
