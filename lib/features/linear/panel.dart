/// LINEAR tab made up of config and panel widgets.
//
// Time-stamp: <Thursday 2024-06-13 17:13:55 +1000 Graham Williams>
//
...
import 'package:rattle/features/linear/config.dart';
import 'package:rattle/features/linear/display.dart';

/// The LINEAR feature supports linear rule analysis.

class LinearPanel extends StatelessWidget {
  const LinearPanel({super.key});
