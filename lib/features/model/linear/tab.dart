...
import 'package:rattle/features/model/linear/config.dart';
import 'package:rattle/features/model/linear/panel.dart';

/// The LINEAR feature supports linear rule analysis.

class LinearTab extends StatelessWidget {
  const LinearTab({super.key});
