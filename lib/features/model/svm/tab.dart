...
import 'package:rattle/features/model/svm/config.dart';
import 'package:rattle/features/model/svm/panel.dart';

/// The SVM feature supports Svm rule analysis.

class SvmTab extends StatelessWidget {
  const SvmTab({super.key});
