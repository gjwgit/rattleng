...
class CorrelationPanel extends ConsumerStatefulWidget {
  const CorrelationPanel({super.key});

  @override
  ConsumerState<CorrelationPanel> createState() => _CorrelationPanelState();
}

class _CorrelationPanelState extends ConsumerState<CorrelationPanel> {
  @override
