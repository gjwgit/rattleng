...
class VisualPanel extends ConsumerStatefulWidget {
  const VisualPanel({super.key});

  @override
  ConsumerState<VisualPanel> createState() => _VisualPanelState();
}

class _VisualPanelState extends ConsumerState<VisualPanel> {
  @override
