...
class TestsPanel extends ConsumerStatefulWidget {
  const TestsPanel({super.key});

  @override
  ConsumerState<TestsPanel> createState() => _TestsPanelState();
}

class _TestsPanelState extends ConsumerState<TestsPanel> {
  @override
