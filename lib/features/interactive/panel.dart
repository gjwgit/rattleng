/// INTERACTIVE tab made up of config and panel widgets.
//
// Time-stamp: <Friday 2024-06-14 10:02:57 +1000 Graham Williams>
//
...
import 'package:rattle/features/interactive/config.dart';
import 'package:rattle/features/interactive/display.dart';

/// The INTERACTIVE tab provides a data oriented view of the loaded dataset.
    ...
    return const Scaffold(
      body: Column(
        children: [
          ...
          Expanded(child: InteractiveDisplay()),
        ],
      ),
    );
  }
